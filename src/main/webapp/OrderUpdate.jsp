...
<form name="myForm" action="OrderUpdateServlet" onsubmit="return validateForm()" method="post" >
...
<table>
    ...
    <tr>
   <th><h3>Supplier Order ID</h3></th> <th><input type="text"  name="sup_oid" id="sup_oid" placeholder="Supplier Order ID"  value="<%=rs.getString(1)%>" readonly><br><br></th></tr>
    
  
    <tr>
   <th> <h3>Quantity</h3></th>  <th><input  type="text" name="qty" name="text" id="qty" placeholder="Quantity"  value="<%=rs.getString(2)%>" ><br><br></th></tr>
   
   <tr>
   <th> <h3>Date</h3></th>  <th><input  type="text" name="date" name="text" id="date" placeholder="Date"  value="<%=rs.getString(3)%>" ><br><br></th></tr>
   
     <tr>
   <th> <h3>Company ID</h3></th>  <th><input  type="text" name="comp_id" name="text" id="comp_id" placeholder="Company ID"  value="<%=rs.getString(4)%>" ><br><br></th></tr>
   
   <tr>
   <th> <h3>Row Material ID</h3></th>  <th><input  type="text" name="mat_id" name="text" id="mat_id" placeholder="Row Material ID"  value="<%=rs.getString(5)%>" ><br><br></th></tr>
