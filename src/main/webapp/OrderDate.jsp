...
<h2>View Order Report</h2></center><br><br>
<br>
<br>
<br>
<br>

<form action="OrderReport.jsp">
...
<button type="submit"  name="submit"  id="billb" ><i class="fa fa-search"></i> View Monthly Order Details</button>
