...
<title>Transport Details Update</title>
...
<form name="myForm" action="TransportUpdateServlet" onsubmit="return validateForm()" method="post" >

<div class="topic">
<h1><center>Update Transport Details</h1>	
</div>
<br>
        <br>
        <br>
 ...
 <tr>
   <th> <h3>Transport id</h3></th>  <th><input  type="text" name="t_id" name="text" id="t_id" placeholder="DE1" value="<%=t_id %>"><br><br></th></tr>
    ...
    <th><h3>Shop order id</h3></th> <th><input type="text"  name="shop_order" name="text" id="shop_order" placeholder="D1" value="<%=shop_order %>"><br><br></th></tr>
      ...
      <input type="submit" name="update" value="Update" id="update" onclick="alert('Transport details Updated!');">
    <br><br>
