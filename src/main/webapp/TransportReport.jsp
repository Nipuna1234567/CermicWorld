...
String sql="Select * from transport_details where date like '"+month+"/__/"+year+"'" ;
...
%>
<tr>
<td name="t_id"><%=rs.getString(1)%></td>
<td name="t_distance"><%=rs.getString(2)%></td>
<td name="t_price"><%=rs.getString(3)%></td>
<td name="t_amount"><%=rs.getString(4)%></td>
