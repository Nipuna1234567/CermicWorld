...
String sql="Select * from addsup_order" ;
...
<td><a href='OrderUpdate.jsp?sup_oid=<%=rs.getString(1) %>' class="update" id="deliver2">Update</a></td>
<td><a href='OrderDelete.jsp?sup_oid=<%=rs.getString(1) %>' class="update" id="delete2">Delete</a></td>
